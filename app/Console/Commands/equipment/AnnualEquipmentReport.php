...
class AnnualEquipmentReport extends Command
{
    ...
    protected $description = 'Generate the annual equipment report';
    ...
    public function handle(): void
    {
        ...
        <div style="width: 100%; font-family: Arial, Helvetica, sans-serif">
            ...
            <div style="margin: auto; justify-content:center">
                ...
                <div style="margin: auto; width: 80%">
                    <span>
                        <i> *Note: Equipments listed below are based on this year\'s entry. If the equipment you wish to see is
        ...
        $this->info('Annual equipment report generated successfully.');
    }
}
