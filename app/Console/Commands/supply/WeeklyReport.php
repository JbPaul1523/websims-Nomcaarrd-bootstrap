...
class WeeklyReport extends Command
{
    ...
    protected $description = 'Generate the weekly supply report';
    ...
    public function handle(): void
    {
        ...
        <div style="width: 100%; font-family: Arial, Helvetica, sans-serif">
            ...
            <div style="margin: auto; justify-content:center">
                <p style="text-align: center; font-weight: 700; font-size: 1.15rem">WEEKLY REPORT AS OF ' . now()->format('F j, Y') . '</p>
                <div style="margin: auto; width: 80%">
                    <span>
                        <i> *Note: Supplies listed below are based on this week\'s entry. If the supply you wish to see is
        ...
        $this->info('Weekly supply report generated successfully.');
    }
}
