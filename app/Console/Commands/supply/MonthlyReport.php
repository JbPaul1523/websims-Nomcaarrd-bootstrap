...
class MonthlyReport extends Command
{
    ...
    protected $description = 'Generate the monthly supply report';
    ...
    public function handle(): void
    {
        ...
        <div style="width: 100%; font-family: Arial, Helvetica, sans-serif">
            ...
            <div style="margin: auto; justify-content:center">
                ...
                <div style="margin: auto; width: 80%">
                    <span>
                        <i> *Note: Supplies listed below are based on this month\'s entry. If the supply you wish to see is
        ...
        $this->info('Monthly supply report generated successfully.');
    }
}
